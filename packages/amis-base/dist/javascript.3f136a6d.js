import { r as xe } from "./codemirror.813d9e5a.js";
function he(Y, cr) {
    ...
    if (typeof z != "string" && !Array.isArray(z)) {
      for (const x in z)
        if (x !== "default" && !(x in Y)) {
          ...
          T && Object.defineProperty(Y, x, T.get ? T : {
            enumerable: !0,
            get: () => z[x]
          });
        }
...
(function(Y, cr) {
  (function(b) {
    ...
    b.defineMode("javascript", function(z, x) {
      var T = z.indentUnit, hr = x.statementIndent, Z = x.jsonld, M = x.json || Z, vr = x.trackScope !== !1, p = x.typescript, C = x.wordCharacters || /[\w$\xa1-\uffff]/, gr = function() {
        function r(g) {
      ...
      }(), yr = /[+\-*&%=<>!?|~^@]/, Dr = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/;
      function Jr(r) {
      ...
      function O(r, e) {
        var t = r.next();
        if (t == '"' || t == "'")
          return e.tokenize = Lr(t), e.tokenize(r, e);
        ...
        if (t == "/")
          return r.eat("*") ? (e.tokenize = er, er(r, e)) : r.eat("/") ? (r.skipToEnd(), w("comment", "comment")) : Pr(r, e, 1) ? (Jr(r), r.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), w("regexp", "string-2")) : (r.eat("="), w("operator", "operator", r.current()));
        if (t == "`")
      ...
      function lr(r, e) {
        ...
        if (!(t < 0)) {
          ...
          for (var u = 0, l = !1, m = t - 1; m >= 0; --m) {
            var g = r.string.charAt(m), A = Qr.indexOf(g);
            if (A >= 0 && A < 3) {
              if (!u) {
                ++m;
                break;
      ...
      function Tr(r, e) {
        if (e)
          if (e.block) {
            ...
            return dr(r, e.vars) ? e : new W(e.prev, new K(r, e.vars), !1);
        else
          return null;
      }
      function nr(r) {
      ...
      function s(r, e) {
        var t = function() {
          ...
          if (f.lexical.type == "stat")
            ...
            for (var l = f.lexical; l && l.type == ")" && l.align; l = l.prev)
              u = l.indented;
      ...
      function h(r, e) {
        return r == "var" ? n(s("vardef", e), wr, c(";"), a) : r == "keyword a" ? n(s("form"), mr, h, a) : r == "keyword b" ? n(s("form"), h, a) : r == "keyword d" ? i.stream.match(/^\s*$/, !1) ? n() : n(s("stat"), F, c(";"), a) : r == "debugger" ? n(c(";")) : r == "{" ? n(s("}"), tr, ar, a, j) : r == ";" ? n() : r == "if" ? (i.state.lexical.info == "else" && i.state.cc[i.state.cc.length - 1] == a && i.state.cc.pop()(), n(s("form"), mr, h, a, zr)) : r == "function" ? n(_) : r == "for" ? n(s("form"), tr, Mr, h, j, a) : r == "class" || p && e == "interface" ? (i.marked = "keyword", n(s("form", r == "class" ? r : e), $r, a)) : r == "variable" ? p && e == "declare" ? (i.marked = "keyword", n(h)) : p && (e == "module" || e == "enum" || e == "type") && i.stream.match(/^\s*\w/, !1) ? (i.marked = "keyword", e == "enum" ? n(Br) : e == "type" ? n(Or, c("operator"), d, c(";")) : n(s("form"), E, c("{"), s("}"), ar, a, a)) : p && e == "namespace" ? (i.marked = "keyword", n(s("form"), k, h, a)) : p && e == "abstract" ? (i.marked = "keyword", n(h)) : n(s("stat"), Zr) : r == "switch" ? n(
          ...
          a,
          j
        ) : r == "case" ? n(k, c(":")) : r == "default" ? n(c(":")) : r == "catch" ? n(s("form"), $, Kr, h, a, j) : r == "export" ? n(s("stat"), le, a) : r == "import" ? n(s("stat"), de, a) : r == "async" ? n(h) : e == "@" ? n(k, h) : o(s("stat"), k, c(";"), a);
      }
      function Kr(r) {
        if (r == "(")
          return n(B, c(")"));
      ...
      function Ar(r, e, t) {
        if (i.state.fatArrowAt == i.stream.start) {
          var f = t ? Ir : Vr;
          if (r == "(")
            return n($, s(")"), v(B, ")"), a, c("=>"), f, j);
          if (r == "variable")
            return o($, E, c("=>"), f, j);
        }
        var u = t ? D : q;
        return Rr.hasOwnProperty(r) ? n(u) : r == "function" ? n(_, u) : r == "class" || p && e == "interface" ? (i.marked = "keyword", n(s("form"), ce, a)) : r == "keyword c" || r == "async" ? n(t ? y : k) : r == "(" ? n(s(")"), F, c(")"), a, u) : r == "operator" || r == "spread" ? n(t ? y : k) : r == "[" ? n(s("]"), pe, a, u) : r == "{" ? H(fr, "}", null, u) : r == "quasi" ? o(ir, u) : r == "new" ? n(Gr(t)) : n();
      }
      function F(r) {
      ...
      function D(r, e, t) {
        var f = t == !1 ? q : D, u = t == !1 ? k : y;
        if (r == "=>")
          return n($, t ? Ir : Vr, j);
        if (r == "operator")
          return /\+\+|--/.test(e) || p && e == "!" ? n(f) : p && e == "<" && i.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1) ? n(s(">"), v(d, ">"), a, f) : e == "?" ? n(k, c(":"), u) : n(u);
        if (r == "quasi")
          return o(ir, f);
        if (r != ";") {
          if (r == "(")
      ...
      function Hr(r) {
        if (r == "}")
          return i.marked = "string-2", i.state.tokenize = U, n(ir);
      }
      function Vr(r) {
      ...
      function fr(r, e) {
        if (r == "async")
          return i.marked = "property", n(fr);
        if (r == "variable" || i.style == "keyword") {
          if (i.marked = "property", e == "get" || e == "set")
            return n(re);
          var t;
          return p && i.state.fatArrowAt == i.stream.start && (t = i.stream.match(/^\s*:\s*/, !1)) && (i.state.fatArrowAt = i.stream.pos + t[0].length), n(N);
        } else {
      ...
      function v(r, e, t) {
        function f(u, l) {
          if (t ? t.indexOf(u) > -1 : u == ",") {
            ...
            return m.info == "call" && (m.pos = (m.pos || 0) + 1), n(function(g, A) {
      ...
      function Sr(r) {
        if (p && r == ":")
          return i.stream.match(/^\s*\w+\s+is\b/, !1) ? n(k, ne, d) : n(d);
      }
      function ne(r, e) {
        if (e == "is")
      ...
      function G(r, e) {
        if (r == "variable" || i.style == "keyword")
          return i.marked = "property", n(G);
        if (e == "?" || r == "number" || r == "string")
          return n(G);
        if (r == ":")
          return n(d);
        if (r == "[")
          return n(c("variable"), ee, c("]"), G);
        if (r == "(")
          return o(Q, G);
        if (!r.match(/[;\}\)\],]/))
          return n();
      ...
      function ie(r) {
        if (r == "}")
          return i.marked = "string-2", i.state.tokenize = U, n(kr);
      }
      function br(r, e) {
        return r == "variable" && i.stream.match(/^\s*[?:]/, !1) || e == "?" ? n(br) : r == ":" ? n(d) : r == "spread" ? n(br) : o(d);
      }
      function V(r, e) {
        if (e == "<")
          return n(s(">"), v(d, ">"), a, V);
      ...
      function _r(r, e) {
        return r == "variable" && !i.stream.match(/^\s*:/, !1) ? (P(e), n(S)) : (r == "variable" && (i.marked = "property"), r == "spread" ? n(E) : r == "}" ? o() : r == "[" ? n(k, c("]"), c(":"), _r) : n(c(":"), E, S));
      }
      function ue() {
        return o(E, S);
      }
      ...
      function L(r, e) {
        return r == ")" ? n() : r == ";" ? n(L) : e == "in" || e == "of" ? (i.marked = "keyword", n(k, L)) : o(k, L);
      }
      function _(r, e) {
        if (e == "*")
      ...
      function Q(r, e) {
        ...
        if (r == "variable")
          return P(e), n(Q);
        if (r == "(")
          return n($, s(")"), v(B, ")"), a, Sr, j);
        if (p && e == "<")
          return n(s(">"), v(ur, ">"), a, Q);
      }
      function Or(r, e) {
        if (r == "keyword" || r == "variable")
          return i.marked = "type", n(Or);
        if (e == "<")
          return n(s(">"), v(ur, ">"), a);
      }
      function B(r, e) {
        return e == "@" && n(k, B), r == "spread" ? n(B) : p && nr(e) ? (i.marked = "keyword", n(B)) : p && r == "this" ? n(J, S) : o(E, J, S);
      }
      function ce(r, e) {
      ...
      function I(r, e) {
        if (r == "async" || r == "variable" && (e == "static" || e == "get" || e == "set" || p && nr(e)) && i.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
          return i.marked = "keyword", n(I);
        if (r == "variable" || i.style == "keyword")
          return i.marked = "property", n(X, I);
        if (r == "number" || r == "string")
          return n(X, I);
        if (r == "[")
          return n(k, J, c("]"), X, I);
      ...
      function le(r, e) {
        return e == "*" ? (i.marked = "keyword", n(xr, c(";"))) : e == "default" ? (i.marked = "keyword", n(k, c(";"))) : r == "{" ? n(v(qr, "}"), xr, c(";")) : o(h);
      }
      function qr(r, e) {
        if (e == "as")
      ...
      function sr(r, e) {
        return r == "{" ? H(sr, "}") : (r == "variable" && P(e), e == "*" && (i.marked = "keyword"), n(me));
      }
      function Nr(r) {
        if (r == ",")
          return n(sr, Nr);
      ...
      function be(r, e) {
        return r.lastType == "operator" || r.lastType == "," || yr.test(e.charAt(0)) || /[,.]/.test(e.charAt(0));
      }
      function Pr(r, e, t) {
        return e.tokenize == O && /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(e.lastType) || e.lastType == "quasi" && /\{\s*$/.test(r.string.slice(0, r.pos - (t || 0)));
      }
      return {
        ...
        token: function(r, e) {
          if (r.sol() && (e.lexical.hasOwnProperty("align") || (e.lexical.align = !1), e.indented = r.indentation(), lr(r, e)), e.tokenize != er && r.eatSpace())
            return null;
          var t = e.tokenize(r, e);
          return R == "comment" ? t : (e.lastType = R == "operator" && (rr == "++" || rr == "--") ? "incdec" : R, Er(e, t, R, rr, r));
        },
        indent: function(r, e) {
          if (r.tokenize == er || r.tokenize == U)
            return b.Pass;
          if (r.tokenize != O)
            return 0;
          ...
          for (; (f.type == "stat" || f.type == "form") && (t == "}" || (u = r.cc[r.cc.length - 1]) && (u == q || u == D) && !/^[,\.=+\-*:?[\(]/.test(e)); )
            f = f.prev;
          hr && f.type == ")" && f.prev.type == "stat" && (f = f.prev);
          var g = f.type, A = t == g;
          return g == "vardef" ? f.indented + (r.lastType == "operator" || r.lastType == "," ? f.info.length + 1 : 0) : g == "form" && t == "{" ? f.indented : g == "form" ? f.indented + T : g == "stat" ? f.indented + (be(r, e) ? hr || T : 0) : f.info == "switch" && !A && x.doubleIndentSwitch != !1 ? f.indented + (/^(?:case|default)\b/.test(e) ? T : 2 * T) : f.align ? f.column + (A ? 0 : 1) : f.indented + (A ? 0 : T);
        },
...
const ve = Fr.exports, ye = /* @__PURE__ */ he({
  __proto__: null,
  default: ve
}, [Fr.exports]);
export {
